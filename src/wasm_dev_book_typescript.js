/* tslint:disable */
import * as wasm from './wasm_dev_book_typescript_bg';
import { date_now } from './index';
import { console_log } from './index';

export function __wbg_f_date_now_date_now_n() {
    return date_now();
}
...
export function __wbg_f_console_log_console_log_n(arg0) {
...
export function twice(arg0) {
    const [ptr0, len0] = passArray32ToWasm(arg0);
    setGlobalArgument(len0, 0);
    try {
        const ret = wasm.twice(ptr0);
